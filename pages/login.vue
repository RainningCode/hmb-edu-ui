<template>
  <div class="login_page">
          ...
          <div class="form_body r180" v-if="tabp == 2">
            <form action @submit="regSubmit">
              ...
              <div class="mgt20 font_14">
                ...
                <a href="jvascript:" class="c_blue" @click="xieyi = true">《用户协议》</a>
              </div>
        ...
        <div class="login_form" v-else>
          ...
          <div class="form_body">
            ...
            <ul class="btn_box clearfix">
              <li>
                <nuxt-link :to="{name: 'account-teacher'}">用户中心</nuxt-link>
              </li>
              <li>
    ...
    <div class="login_footer">
      ...
      <p>
        <a href="http://www.roncoo.net/" class="lingke_link">黑曼巴教育云</a> 提供技术支持
