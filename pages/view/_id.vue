      ...
      <div class="layout_left">
        <ul class="course_tab clearfix">
          <li :class="{on: tab == 'info'}">
            <a href="javascript:" @click="tab = 'info'">课程介绍</a>
          </li>
          <li :class="{on: tab == 'big'}">
            <a href="javascript:" @click="tab = 'big'">录播课程</a>
          </li>
        </ul>
        ...
        <div class="teacher_info clearfix">
          ...
          <div class="teacher_msg">
            <div class="teacher_msg_right">
              <img
                class="teacher_phone"
                v-if="teacherInfo.headImgUrl"
                :src="teacherInfo.headImgUrl"
                alt
              >
...
export default {
  ...
  methods: {
      ...
      if (this.courseInfo.isPay || data.isFree) {
        ...
        chapterSign({
          ...
          .then(res => {
            ...
            console.log("res==========");
            if (res.code === 200) {
              console.log("video id : " + data.videoVid);
    ...
    play(data) {
      ...
      let video = this.$refs.watchVideo.$refs.video;
      // if (this.player) {
