  ...
  <div class="applymsg_page">
    <div class="register">
        ...
        <div class="register_content">
          ...
          <div v-if="tab === 1">
            ...
            <footer class="info_footer">
              ...
              <label for="isRead">我已阅读并同意此协议</label>
      ...
      <p class="foot_text">
        ...
        <a
          :href="'http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=' + webInfo.prnNo"
          target="_blank"
          class="lingke_link"
          v-if="webInfo.prn"
        >
  ...
  methods: {
    ...
    isSubmit() {
      if (
        ...
        this.obj.mobile.trim().length !== 11
      ) {
